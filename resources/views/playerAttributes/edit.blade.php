        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading"><center>UPDATE PLAYER ATTRIBUTES</center></div>

                    <div class="panel-body">
                        {!! Form::model($playerAttribute, array('route'=>['playerAttributes.update', $playerAttribute->id], 'method'=>'PUT')) !!}
                        <div class="form-group">
                            {!! Form::label('player_api_id','Select The Player API ID') !!}
                            {!! Form::select('player_api_id', \App\Player::all()->pluck('player_name', 'player_api_id')->toArray(), null,['class'=>'select2 form-control', 'placeholder' => 'Choose Player...']) !!}
                        </div>
